# Vendored from https://github.com/jayg996/BTC-ISMIR19
# commit 2682317be668032e6e4b269ded36adaa2ad57df0 (MIT License, see LICENSE).
# Local patches: package-relative imports; HParams import and the
# __main__ smoke block removed (config is supplied as a plain dict by
# tone_forge.analysis.btc_chords). No model-logic changes.
