# Coverage Dashboard  (pool = 4466 assets)

dimension              coverage   assets  diversity confidence
genre                  ████████████  4280       5     0.96
gain                   ████........  4466       1     1.00
guitar_type            ████........  4466       2     1.00
pickup                 ............     0       0     0.00
tempo                  ████████████  4466       4     1.00
key                    ████████████  4466      24     1.00
masking_level          ███.........  2232       1     0.50
recording_style        ████████████  4466       3     1.00
acoustic_vs_electric   ████████████  4466       2     1.00
difficulty             ████████████  4466       1     1.00
synthetic_vs_real      ████████████  4466       1     1.00
license_class          ████████████  4466       1     1.00
amp_family             ............     0       0     0.00
recording_method       █████████...  4466       3     1.00
tuning                 ............     0       0     0.00
string_count           ............     0       0     0.00
capo                   ████████████     0       0     0.00
playing_style          ............  4466       8     1.00
articulation           ............  4466       8     1.00
player_identity        ████████████  4466       8     1.00
recording_quality      ████████████  2232       1     0.50
provenance_confidence  ████████████  4466       1     1.00

# Coverage Heatmap (target regimes; . = empty)

## acoustic_vs_electric
  electric       ..........  186  (impact 1.5)
  acoustic       ██████████ 4280  (impact 1.0)

## guitar_type
  distorted      ..........    0  (impact 1.6)  GAP
  acoustic       ██████████ 4280  (impact 1.0)
  clean          ..........    0  (impact 1.0)  GAP

## pickup
  bridge         ..........    0  (impact 1.2)  GAP
  neck           ..........    0  (impact 1.0)  GAP
  middle         ..........    0  (impact 1.0)  GAP

## gain
  med            ..........    0  (impact 1.6)  GAP
  high           ..........    0  (impact 1.4)  GAP
  low            ██████████ 4466  (impact 1.0)
...
## recording_method
  di             ..........  126  (impact 1.8)
  amp_mic        ..........   60  (impact 1.2)
  di_processed   ..........    0  (impact 1.2)  GAP
  acoustic       ██████████ 4280  (impact 1.0)
...
- articulation=PalmMute: have 0 (deficit 100%), impact 1.6 -> green. more of Guitar-TECHS techniques (free) + commission gaps
...
- guitar_type=distorted: have 0 (deficit 100%), impact 1.6 -> commission. record/license to spec
...
- gain=high: have 0 (deficit 100%), impact 1.4 -> commission. green tier is bimodal (clean vs high); record edge/crunch DI
...
- recording_method=di_processed: have 0 (deficit 100%), impact 1.2 -> green. Guitar-TECHS DI + more green
- articulation=Vibrato: have 0 (deficit 100%), impact 1.2 -> green. more of Guitar-TECHS techniques (free) + commission gaps
...
- pickup=bridge: have 0 (deficit 100%), impact 1.2 -> commission. record/license to spec
...
- guitar_type=clean: have 0 (deficit 100%), impact 1.0 -> commission. record/license to spec
- pickup=neck: have 0 (deficit 100%), impact 1.0 -> commission. record/license to spec
- pickup=middle: have 0 (deficit 100%), impact 1.0 -> commission. record/license to spec
...
- articulation=PinchHarmonics: have 2 (deficit 48%), impact 1.8 -> green. more of Guitar-TECHS techniques (free) + commission gaps
- articulation=Harmonics: have 2 (deficit 44%), impact 1.4 -> green. more of Guitar-TECHS techniques (free) + commission gaps
- articulation=Bendings: have 3 (deficit 40%), impact 1.2 -> green. more of Guitar-TECHS techniques (free) + commission gaps
...
10 articulation=PalmMute              green         low      1.6   3.20 1.60
...
# ROI Report (coverage-gain x impact / cost)
  ...
  ROI   3.20  articulation=PalmMute       (impact 1.6, cost low, green)
...
- recording_method=di_processed: green — Guitar-TECHS DI + more green (cost~low, impact 1.2)
...
3. INGEST (free green): articulation=PalmMute — ROI 3.20, impact 1.6. more of Guitar-TECHS techniques (free) + commission gaps
