...
SCENARIOS: dict = {
    ...
    "blues_shuffle": Scenario(
        name="blues_shuffle", version="v1", benchmark_regime="clean_electric_under_vocal",
        description="Male vocal, shuffle drums, bass, organ. Warm, medium-light masking.",
        guitar_level_db=-3.5, guitar_pan=0.15, masking_db=2.5, compression=0.25,
        roles=(RoleSpec("vocals", -3.0, 0.0, is_masker=True, voice="male"),
               RoleSpec("drums", -6.5, 0.0, voice="live"),
               RoleSpec("bass", -7.5, 0.0, voice="electric"),
               RoleSpec("keys", -9.0, -0.25, voice="organ"))),
    "funk": Scenario(
        name="funk", version="v1", benchmark_regime="percussive_clean",
        description="Tight rhythm, slap bass, clav, drums. High comp, percussive, bright.",
        guitar_level_db=-5.0, guitar_pan=0.3, masking_db=3.5, compression=0.65,
        roles=(RoleSpec("drums", -5.0, 0.0, voice="live"),
               RoleSpec("bass", -6.0, 0.0, voice="electric"),
               RoleSpec("keys", -7.0, -0.3, is_masker=True, voice="clav"),
               RoleSpec("vocals", -4.0, 0.0, is_masker=True, voice="male"))),
    "singer_songwriter": Scenario(
        name="singer_songwriter", version="v1", benchmark_regime="acoustic_under_vocal",
        description="Intimate female vocal + acoustic. Almost no backing, tiny masking.",
        guitar_level_db=-2.0, guitar_pan=0.0, masking_db=1.0, compression=0.05,
        roles=(RoleSpec("vocals", -4.0, 0.0, is_masker=True, voice="female"),)),
    "indie_rock": Scenario(
        name="indie_rock", version="v1", benchmark_regime="clean_electric_under_vocal",
        description="Jangly electric, driving drums, bass, reverby vocal. Medium masking.",
        guitar_level_db=-4.5, guitar_pan=-0.25, masking_db=4.0, compression=0.4,
        roles=(RoleSpec("vocals", -3.0, 0.1, is_masker=True, voice="male"),
               RoleSpec("drums", -5.5, 0.0, voice="live"),
               RoleSpec("bass", -7.0, 0.0, voice="electric"),
               RoleSpec("synth", -10.0, 0.35, voice="pad"))),
    "prog_metal": Scenario(
        name="prog_metal", version="v1", benchmark_regime="heavy_masking",
        description="Djent rhythm, dense kick, growl+clean vox, synth. Extreme, high comp.",
        guitar_level_db=-4.0, guitar_pan=-0.35, masking_db=7.0, compression=0.7,
        roles=(RoleSpec("vocals", -2.0, 0.0, is_masker=True, voice="scream"),
               RoleSpec("drums", -2.5, 0.0, voice="triggered"),
               RoleSpec("bass", -4.5, 0.0, voice="electric"),
               RoleSpec("keys", -7.0, 0.3, is_masker=True, voice="pad"),
               RoleSpec("synth", -9.0, -0.3, is_masker=True, voice="lead"))),
    "reggae": Scenario(
        name="reggae", version="v1", benchmark_regime="sparse_clean",
        description="Offbeat skank, deep bass, one-drop drums, organ. Bass-forward, sparse.",
        guitar_level_db=-6.0, guitar_pan=0.4, masking_db=1.5, compression=0.2,
        roles=(RoleSpec("bass", -4.0, 0.0, voice="electric"),
               RoleSpec("drums", -6.0, 0.0, voice="live"),
               RoleSpec("keys", -8.0, -0.3, voice="organ"),
               RoleSpec("vocals", -5.0, 0.0, is_masker=True, voice="male"))),
    "edm_pop": Scenario(
        name="edm_pop", version="v1", benchmark_regime="dense_synth_masking",
        description="Wall of synths, four-on-floor, sidechain-style comp, bright vocal.",
        guitar_level_db=-7.0, guitar_pan=0.2, masking_db=5.5, compression=0.75,
        roles=(RoleSpec("synth", -3.0, -0.2, is_masker=True, voice="lead"),
               RoleSpec("synth", -5.0, 0.3, is_masker=True, voice="pad"),
               RoleSpec("vocals", -2.5, 0.0, is_masker=True, voice="pop"),
               RoleSpec("drums", -5.0, 0.0, voice="electronic"),
               RoleSpec("bass", -6.0, 0.0, voice="synth"))),
}
