...
//
// In-memory MIDIInterface for USBLaunchpadTransportTests: scripted
// endpoints, captured sends, and synchronous injection of received
// messages. The Launchpad endpoints mirror the names the physical
// device exposes over CoreMIDI (hardware-verified).
...
final class FakeMIDIInterface: MIDIInterface {
    ...
    // nonisolated: Sendable value constants used as default parameter
    // values (nonisolated context under Swift 6).
